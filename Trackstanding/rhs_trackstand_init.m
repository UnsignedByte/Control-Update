function [zdot,u]=rhs_trackstand_init(currentState,p,K,init_u, delta_offset, phi_offset,linear)
...
u=k1*(phi-phi_offset)+k2*phi_dot+k3*(v)+init_u; %u, control variable, is delta dot
%fprintf(" delta - deltaoff  : " +(delta-delta_offset)+"\n");

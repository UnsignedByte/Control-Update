...
%controller gains:
K1= [11.1,2.4,-6.6]; %lqr
K2= [11.1,2.4,-6.6];%23,16,-2]; %large grid search optimization
K3= [11.1,2.4,-6.6];%[71,21,-20]; %old gains from daniel (from nav sim)
K4= [11.1,2.4,-6.6];%[71,10,-20]; %other old gains
